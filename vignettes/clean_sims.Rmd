...
sim_normal_large <- run_simulation_general(scenarios_normal_large,B=10000,rule=cond_power_rule_norm,test_statistic=diffmean,rdist=rnorm)
...
sim_nonnormal_large <- run_simulation_general(scenarios_nonnormal_large,B=10000,rule=cond_power_rule_norm,test_statistic=diffmean,rdist=rnorm_cont)
...
sim_nonnormal_small <- run_simulation_general(scenarios_nonnormal_small,B=10000,rule=cond_power_rule_norm_max,test_statistic=diffmean,rdist=rnorm_hetero)
