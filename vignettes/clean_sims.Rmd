...
scenarios_test <- expand.grid(n1=6,
                              n=12,
                              mean=round(seq(0,1.2,.6),2),
                              sd=c(1,1.2),
                              perms = 500,
                              resam = 500)
...
sim_normal_small <- run_simulation_general(scenarios_normal_small,B=10000,rule=cond_power_rule_norm,test_statistic=diffmean,rdist=rnorm)
...
sim_nonnormal_small <- run_simulation_general(scenarios_nonnormal_small,B=100,rule=cond_power_rule_norm,test_statistic=diffmean,rdist=rnorm_hetero)
...
sim_normal_large <- run_simulation_general(scenarios_normal_large,B=10000,rule=cond_power_norm,test_statistic=diffmean,rdist=rnorm)
...
sim_nonnormal_large <- run_simulation_general(scenarios_nonnormal_large,B=10000,rule=cond_power_norm,test_statistic=diffmean,rdist=rnorm_cont)
