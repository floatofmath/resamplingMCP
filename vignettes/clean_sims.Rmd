...
sim_normal_sr_large <- run_simulation_general(scenarios_normal_large,B=5000,rule=cond_power_rule_norm,test_statistic=signedranks,rdist=rnorm)
save(sim_normal_sr_large,file=vfile("~/repos/resamplingMCP/data/sim_normal_sr_large"))
...
sim_nonnormal_sr_large <- run_simulation_general(scenarios_nonnormal_large,B=5000,rule=cond_power_rule_norm,test_statistic=signedranks,rdist=rnorm_cont)
save(sim_nonnormal_sr_large,file=vfile("~/repos/resamplingMCP/data/sim_nonnormal_sr_large"))
