...
out1 <- type1_randomization(rnorm,4,8,100)
out2 <- type1_randomization(rnorm,6,12,100)
out3 <- type1_randomization(rnorm,8,16,100,B=5000)
out <- type1_randomization(rnorm,,40,100)
out <- type1_randomization(rnorm,100,200,100)
